...
/**
 * From https://raw.githubusercontent.com/craftcms/cms/master-v2/src/helpers/ArrayHelper.php
 *
 * Class ArrayHelper
 * @package GALes\MakerBundle\Helper
 */
class ArrayHelper
{
    // Public Methods
    ...
    {
        return array_filter($arr, array(self::class, '_isNotAnEmptyString'));
    }
